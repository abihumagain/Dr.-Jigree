...
const EMPTY_VITAL = { record_type: 'vital', title: '', systolic_bp: '', diastolic_bp: '', heart_rate: '', temperature: '', oxygen_sat: '', notes: '' };
const EMPTY_LAB   = { record_type: 'lab',   title: '', glucose: '', cholesterol: '', hdl: '', ldl: '', triglycerides: '', hba1c: '', notes: '' };
...
export default function Records() {
  ...
  const load = () => api.get('/health-records').then(r => setRecords(r.data)).finally(() => setLoading(false));
